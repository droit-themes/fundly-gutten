<?php 
  ...
  * Display page banner 
  */
$show_banner = fundly_opt('give_wp_banner_toggle', 'show');
$show_banner_in_page = fundly_page_meta('is_banner', get_the_ID(), 1);

$banner_url = fundly_opt('give_wp_banner_img_upload');
$banner_url_page= fundly_page_meta('banner_background_image', get_the_ID());  

$how_title = fundly_opt('is_give_wp_title', 'show');
$show_breadcrumbs = fundly_opt('give_wp_banner_breadcrumb', 'show');

$banner_background_url = FUNDLY_IMAGES.'/blog/banner/givwp.webp';
