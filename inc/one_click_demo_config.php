...
add_filter( 'pt-ocdi/import_files', 'fundly_import_files' );
function fundly_import_files() {
    return array(

        array(
            'import_file_name'             => esc_html__('All Demos', 'fundly'),
...
function fundly_after_import_setup( $selected_import ) {
...
add_action( 'pt-ocdi/after_import', 'fundly_after_import_setup' );